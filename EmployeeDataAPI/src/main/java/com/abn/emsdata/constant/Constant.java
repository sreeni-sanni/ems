...
public final class Constant {
    ...
    public static final String ROLE_NOT_FOUND="Role with id [%d] was not found!";
    ...
    public static final String EMPLOYEE_NOT_FOUND_BY_NAME="Employee with useName [%s] was not found!";
